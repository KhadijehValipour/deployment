...
async def rgb2gray(input_file: UploadFile = File(None)):
    if not input_file.content_type.startswith("image/"):
        raise HTTPException(status_code=415, details="Unsupported file type")
    ...
    # If you use JPG, use JPEG in the code below, it doesn't matter for PNG, it applies to both.
